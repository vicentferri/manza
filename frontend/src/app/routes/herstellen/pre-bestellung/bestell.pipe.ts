...
@Pipe({name: 'btransform'})
export class BTransformPipe implements PipeTransform {
     ...
     transform(value : string) : any
     {
        ...
        let nvalue = "Tejido:";
        /*
        nvalue += value.tej_tipo_text;
        nvalue += ",Color:";
        nvalue += value.tej_color_text;
        nvalue += ",Salida:";
        nvalue += value.tej_salida_text;
        */
