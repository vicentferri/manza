...
export class CortinaTipo {
    ...
    getTotal() {
        var total = 0;
        if (this.TipoCortina == 1) {
            total = this.precios.T1_PVP;
        }

        if (this.TipoCortina == 2) {
            total = this.precios.T2_PVP;
        }

        if (this.TipoCortina == 3) {
            total = this.precios.T3_PVP;
        }

        if (this.TipoCortina == 4) {
            total = this.precios.T4_PVP;
        }
    ...
    Vertical_Add_T1(PV_Ancho_1: string, PV_Alto_1: string, PV_Cantidad_1: string,
        ...
        estancia: string, estanciaobs: string, TipoVertical: number, values: any) {
        this.TipoCortina = 3;
        this.PV_SEL_1 = true;
        ...
        var a0 = this.TipoCortina.toString();
        var a2 = this.PV_Ancho_1.toString();
        var a3 = this.PV_Alto_1.toString();
        var a4 = this.PV_Cantidad_1.toString();

        var a5 = ",AL=" + this.PV_AnchoLama_1.toString();
        var a6 = ",PM=" + this.PV_PosicionMecanismo_1.toString();
        var a7 = ",CR=" + this.PV_ColorRiel_1.toString();
        var a8 = ",AC=" + this.PV_Accionamiento_1.toString();
        var a9 = ",TS=" + this.PV_TipoSoporte_1.toString();
        var a10 = ",TR=" + this.PV_TipoRecogida_1.toString();
        var a11 = ",TE=" + this.PV_Tejido_text;
        var a12 = ",C1=" + this.PV_Tejido_c1_text;
        var a13 = ",C2=" + this.PV_Tejido_c2_text;

        var instrucciones = "(" + a0 + ",T1) " + a4 + "x" + a2 + "x" + a3.toUpperCase() + a5.toUpperCase() + a6.toUpperCase() + a7.toUpperCase();
        instrucciones += a8.toUpperCase() + a9.toUpperCase() + a10.toUpperCase() + a11.toUpperCase() + a12.toUpperCase() + a13.toUpperCase();
        this.instrucciones += instrucciones;
    ...
    Vertical_Add_T2(PV_Ancho_2: string, PV_Cantidad_2: string, PV_AlturaMin_2: string, PV_AlturaMax_2: string,
        ...
        var b0 = this.TipoCortina.toString();
        var b2 = this.PV_Ancho_2.toString();
        var b3 = this.PV_AlturaMin_2.toString();
        var b4 = this.PV_AlturaMax_2.toString();
        var b5 = this.PV_Cantidad_2.toString();

        var b6 = ",AL=" + this.PV_AnchoLama_2.toString();
        var b7 = ",PM=" + this.PV_PosicionMecanismo_2.toString();
        var b8 = ",CR=" + this.PV_ColorRiel_2.toString();
        var b9 = ",PA=" + this.PV_Accionamiento_2.toString();
        var b10 = ",TS=" + this.PV_TipoSoporte_2.toString();
        var b11 = ",TR=" + this.PV_TipoRecogida_2.toString();

        var instrucciones = "(" + b0 + ",T2) " + b5 + "x" + b2 + "x" + b3 + "x" + b4 + b6.toUpperCase() + b7.toUpperCase();
        instrucciones += b8.toUpperCase() + b9.toUpperCase() + b10.toUpperCase() + b11.toUpperCase();
        this.instrucciones += instrucciones;
    }


    Compac_Add(junquillo: string, ancho: string, ancho2: string, alto: string, cantidad: string,
