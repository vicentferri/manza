...
export class VerticalComponent implements OnInit, OnChanges {
   ...
   Agregar(): void {
      ...
      if (this.PV_SEL_1) {
         const posTej = this.getPos(this.pv_tejidos_1, parseInt(this.Tipo3_Tejido));
         const tejidoText = posTej >= 0 ? this.pv_tejidos_1[posTej].text : '';

         const posC1 = this.getPos(this.pv_tejidosC_1, parseInt(this.Tipo3_TejidoColor1));
         const tejidoC1Text = posC1 >= 0 ? this.pv_tejidosC_1[posC1].text : '';

         const posC2 = this.getPos(this.pv_tejidosC_2, parseInt(this.Tipo3_TejidoColor2));
         const tejidoC2Text = posC2 >= 0 ? this.pv_tejidosC_2[posC2].text : '';
         ...
         tipo.Vertical_Add_T1(
            ...
            parseInt(this.Tipo3_Tejido), tejidoText,
            parseInt(this.Tipo3_TejidoColor1), tejidoC1Text,
            parseInt(this.Tipo3_TejidoColor2), tejidoC2Text,
