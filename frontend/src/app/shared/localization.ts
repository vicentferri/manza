    ...
    switch (culture) {
        case 'es':
            localization =
            {
                ...
                pagerrangestring: ' desde ',
                pagerpreviousbuttonstring: 'próxima',
                pagernextbuttonstring: 'anterior',
                pagerfirstbuttonstring: 'primera',
                pagerlastbuttonstring: '´última',
                groupsheaderstring: 'Arrastre hasta aquí la columna para agrupar por dicha columna',
                sortascendingstring: 'Ordenar ascendente',
                sortdescendingstring: 'Ordenar descendente',
                sortremovestring: 'Quitar la ordenación',
                ...
                filterselectstring: 'Seleccionar un filtro',
                loadtext: 'Cargando...',
                clearstring: 'Limpiar',
                todaystring: 'Hoy'
            }
