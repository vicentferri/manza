...
function put_empaquetado(req,res){
    ...
    if (values[0] == ''){
        ...
        request.execute('sp_master_sm_empaquetados', 
    ...
    function empaquetados(req,res){

  
            var sqlquery = "select idrow,descripcion from SOL_ARTICULOS_EMPAQUETADO order by descripcion";
