...
function put_instalacion(req,res){
    ...
    if (values[0] == ''){
        ...
        request.execute('sp_master_sm_instalaciones', 
    ...
    function instalaciones(req,res){

   
            var sqlquery = "select idrow,descripcion from SOL_ARTICULOS_INSTALACION_CORTINA order by descripcion";
