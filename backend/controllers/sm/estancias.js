...
function put_estancia(req,res){
    ...
    if (values[0] == ''){
        ...
        request.execute('sp_master_sm_estancias', 
    ...
    function estancias(req,res){
            ...
            var sqlquery = "select idrow,descripcion from SOL_ARTICULOS_ESTANCIAS order by descripcion";
